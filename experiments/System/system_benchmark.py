...
def parse_args(args=None):
    ...
    parser.add_argument('--prompt_length', type=int, required=True, help='Prompt length')
    parser.add_argument('--output_length', type=int, required=True, help='Output length')
...
output_csv = f"{args.prefix}_results.csv"
...
if K_BITS < 16 and V_BITS < 16:
    ...
    for layer in model.model.layers:
        layer.self_attn.config.use_snap = args.use_snap
else:
